-- Add SQLite to SOURCE_TYPE dict so UI can render config form
...
VALUES
  ('SOURCE_TYPE', 'sqlite', 'sqlite',
   '[{"label":"driverName","value":"org.sqlite.JDBC","labelValue":"驱动类"},
     {"label":"jdbcUrl","value":"jdbc:sqlite:/app/data/sqlite/mydb.db","labelValue":"连接串"},
     {"label":"username","value":"","labelValue":"用户名(可留空)"},
     {"label":"password","value":"","labelValue":"密码(可留空)"}]',
